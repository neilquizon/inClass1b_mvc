...
namespace inClass1b_mvc.Migrations
{
    ...
    [Migration("20191205185210_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("inClass1b_mvc.Models.FoodStore.Building", b =>
                {
            ...
            modelBuilder.Entity("inClass1b_mvc.Models.FoodStore.Employee", b =>
                {
            ...
            modelBuilder.Entity("inClass1b_mvc.Models.FoodStore.Invoice", b =>
                {
            ...
            modelBuilder.Entity("inClass1b_mvc.Models.FoodStore.Manufacturer", b =>
                {
            ...
            modelBuilder.Entity("inClass1b_mvc.Models.FoodStore.Product", b =>
                {
            ...
            modelBuilder.Entity("inClass1b_mvc.Models.FoodStore.ProductInvoice", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnName("productID");
            ...
            modelBuilder.Entity("inClass1b_mvc.Models.FoodStore.ProductInvoiceWithQuantity", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnName("productID");
            ...
            modelBuilder.Entity("inClass1b_mvc.Models.FoodStore.ProductPurchaseOrder", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnName("productID");
            ...
            modelBuilder.Entity("inClass1b_mvc.Models.FoodStore.PurchaseOrder", b =>
                {
                    b.Property<int>("PoNum")
                        .HasColumnName("po_num");
            ...
            modelBuilder.Entity("inClass1b_mvc.Models.FoodStore.Store", b =>
                {
                    b.Property<string>("Branch")
                        .HasColumnName("branch")
                        .HasMaxLength(25)
            ...
            modelBuilder.Entity("inClass1b_mvc.Models.FoodStore.Supplier", b =>
                {
                    b.Property<string>("Vendor")
                        .HasColumnName("vendor")
                        .HasMaxLength(25)
            ...
            modelBuilder.Entity("inClass1b_mvc.Models.FoodStore.Employee", b =>
                {
                    b.HasOne("inClass1b_mvc.Models.FoodStore.Store", "BranchNavigation")
                        .WithMany("Employee")
            ...
            modelBuilder.Entity("inClass1b_mvc.Models.FoodStore.Product", b =>
                {
                    b.HasOne("inClass1b_mvc.Models.FoodStore.Manufacturer", "MfgNavigation")
                        .WithMany("Product")
                        .HasForeignKey("Mfg")
                        .HasConstraintName("FK__Product__mfg__3B75D760");

                    b.HasOne("inClass1b_mvc.Models.FoodStore.Supplier", "VendorNavigation")
                        .WithMany("Product")
            ...
            modelBuilder.Entity("inClass1b_mvc.Models.FoodStore.ProductInvoice", b =>
                {
                    b.HasOne("inClass1b_mvc.Models.FoodStore.Invoice", "InvoiceNumNavigation")
                        .WithMany("ProductInvoice")
                        .HasForeignKey("InvoiceNum")
                        .HasConstraintName("FK__ProductIn__invoi__48CFD27E");

                    b.HasOne("inClass1b_mvc.Models.FoodStore.Product", "Product")
                        .WithMany("ProductInvoice")
            ...
            modelBuilder.Entity("inClass1b_mvc.Models.FoodStore.ProductPurchaseOrder", b =>
                {
                    b.HasOne("inClass1b_mvc.Models.FoodStore.PurchaseOrder", "PoNumNavigation")
            ...
            modelBuilder.Entity("inClass1b_mvc.Models.FoodStore.Store", b =>
                {
                    b.HasOne("inClass1b_mvc.Models.FoodStore.Building", "Building")
                        .WithMany("Store")
