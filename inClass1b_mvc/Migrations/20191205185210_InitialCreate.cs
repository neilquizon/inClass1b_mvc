...
namespace inClass1b_mvc.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Building__14E071A0C6BF0997", x => new { x.building_name, x.unit_num });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Manufact__DF50190D19B4697E", x => x.mfg);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Supplier__42A1EB1C65EFFE46", x => x.vendor);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Store__1F8431243854F843", x => x.branch);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Invoice__F9EE1383A8FED16C", x => x.invoiceNum);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Purchase__0FCD54D5D835D5A3", x => x.po_num);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ProductI__028E307222965236", x => new { x.productID, x.invoiceNum });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ProductI__028E30720209C33A", x => new { x.productID, x.invoiceNum });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ProductP__6DEC0407448E736B", x => new { x.productID, x.po_num });
                    table.ForeignKey(
